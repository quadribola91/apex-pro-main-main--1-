        ...
        <div className="flex items-center justify-between h-24">
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-3 bg-white text-gray-800 shadow-xl rounded-xl overflow-hidden opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 min-w-[220px]">
